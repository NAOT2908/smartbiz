...
export class MrpBarcodeKanbanRenderer extends KanbanRenderer {
    setup() {
        super.setup(...arguments);
        const user = useService('user');
        this.barcodeService = useService('barcode');
        this.display_protip = this.props.list.resModel === 'mrp.production';
        onWillStart(async () => {
...
MrpBarcodeKanbanRenderer.template = 'smartbiz_barcode_production.KanbanRenderer';
